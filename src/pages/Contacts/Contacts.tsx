...
import withAutoLoading from '../../hoc/withDispatching';
...
const AutoLoadedContacts = withAutoLoading(ContactsPage, {
  action: fetchContactsData,
  selectContacts,
});

export default AutoLoadedContacts;
